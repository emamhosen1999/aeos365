...
namespace Aero\Platform\Models {
	 ...
	 * @property string $downgrade_policy
	 * @property integer $grace_days
	 * @property integer $trial_days
	 * @property array|null $module_codes
	 ...
	 * @property string|null $regional_pricing
	 * @property string $base_currency
	 * @property float $yearly_price
	 * @property float $monthly_price
	 * @property string|null $description
	 * @property integer $max_storage_gb
	 * @property integer $max_users
	 * @property boolean $supports_custom_duration
	 ...
	 * @property string $id
	 * @property-read mixed $subscribers_count
	 * @property-read mixed $total_subscribers_count
	 * @property-read mixed $trial_count
	 * @property-read mixed $cancelled_count
	 * @property-read mixed $mrr
	 * @property-read mixed $arr
	 * @property-read mixed $features_count
	 * @property-read mixed $modules_count
	 * @property-read mixed $formatted_monthly_price
	 * @property-read mixed $formatted_yearly_price
	 * @property-read mixed $yearly_savings
	 * @property-read mixed $yearly_savings_percent
	 * @property-read mixed $is_free
	 * @property-read \Illuminate\Database\Eloquent\Collection<int, \Aero\Platform\Models\Subscription> $subscriptions
	 * @property-read int|null $subscriptions_count
	 * @property-read \Illuminate\Database\Eloquent\Collection<int, \Aero\Platform\Models\Tenant> $tenants
	 * @property-read int|null $tenants_count
	 * @property-read \Illuminate\Database\Eloquent\Collection<int, \Aero\Platform\Models\Module> $modules
	 ...
	 * @method static \Illuminate\Database\Eloquent\Builder<Plan>|Plan whereTier($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<Plan>|Plan wherePlanType($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<Plan>|Plan whereDurationInMonths($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<Plan>|Plan whereSupportsCustomDuration($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<Plan>|Plan whereMaxUsers($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<Plan>|Plan whereMaxStorageGb($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<Plan>|Plan whereDescription($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<Plan>|Plan whereMonthlyPrice($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<Plan>|Plan whereYearlyPrice($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<Plan>|Plan whereBaseCurrency($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<Plan>|Plan whereRegionalPricing($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<Plan>|Plan whereStripeMonthlyPriceId($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<Plan>|Plan whereStripeYearlyPriceId($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<Plan>|Plan whereStripeProductId($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<Plan>|Plan whereSetupFee($value)
	 ...
	 * @method static \Illuminate\Database\Eloquent\Builder<Plan>|Plan whereModuleCodes($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<Plan>|Plan whereTrialDays($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<Plan>|Plan whereGraceDays($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<Plan>|Plan whereDowngradePolicy($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<Plan>|Plan whereCancellationPolicy($value)
	 ...
	 * @method static \Illuminate\Database\Eloquent\Builder<Plan>|Plan whereVisibility($value)
	 ...
	 * @method static \Illuminate\Database\Eloquent\Builder<Plan>|Plan active() {@see Aero\Platform\Models\Plan::scopeActive()}
	 * @method static \Illuminate\Database\Eloquent\Builder<Plan>|Plan featured() {@see Aero\Platform\Models\Plan::scopeFeatured()}
	 * @method static \Illuminate\Database\Eloquent\Builder<Plan>|Plan ordered() {@see Aero\Platform\Models\Plan::scopeOrdered()}
	 * @method static \Illuminate\Database\Eloquent\Builder<Plan>|Plan monthly() {@see Aero\Platform\Models\Plan::scopeMonthly()}
	 * @method static \Illuminate\Database\Eloquent\Builder<Plan>|Plan yearly() {@see Aero\Platform\Models\Plan::scopeYearly()}
