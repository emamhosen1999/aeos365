...
| - Name prefix: quality.
|
| HRMAC Integration: All routes use 'hrmac:quality.{submodule}' middleware
...
Route::middleware(['auth', 'hrmac:quality'])->group(function () {
...
Route::middleware(['auth', 'hrmac:quality.inspections'])->group(function () {
...
Route::middleware(['auth', 'hrmac:quality.material-lab'])->group(function () {
...
Route::middleware(['auth', 'hrmac:quality.ncr-management'])->group(function () {
