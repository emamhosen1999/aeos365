 ...
 * ------------------------------
 * import { useModule, useModuleEnabled } from '@/Hooks/access/useModule';
 * 
 ...
 * ---------------------------------------------------
 * import RequireModule, { RequireModuleDisabled } from '@/Components/Gates/RequireModule';
 * 
...
export {
    ...
    useModuleAccess,
    useModuleNavigation,
} from '@/Hooks/navigation/useNavigation';
...
export { 
    ...
    RequireModuleDisabled,
    withModuleGuard,
} from '@/Components/Gates/RequireModule';
...
export {
    ...
    FeatureGateInline,
    withFeatureGate,
} from '@/Components/Gates/FeatureGate';
...
// Note: navigationConfig is provided by backend via NavigationRegistry
export {
    getIcon,
