    ...
    return (
        <section ref={ref} className="relative overflow-hidden px-6 pt-28 pb-12 md:pt-36 md:pb-16 lg:px-10 xl:px-16">
            <div
                ...
                style={{
                    background: 'radial-gradient(ellipse 72% 52% at 50% -4%, rgba(99,102,241,0.14) 0%, transparent 66%)',
                }}
            />
            <div
            ...
            >
                ...
                >
                    These Terms govern your access to and use of aeos365 services, websites, and related products.
                    Please read carefully before creating a workspace, inviting users, or enabling paid subscriptions.
                </motion.p>
                ...
                <motion.div
                    ...
                    style={{
                        ...
                        borderColor: isDark ? 'rgba(99,102,241,0.22)' : 'rgba(99,102,241,0.22)',
