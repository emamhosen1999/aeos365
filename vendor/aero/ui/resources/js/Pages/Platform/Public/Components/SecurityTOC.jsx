...
const tocLinks = [
    { href: '#overview', label: '1. Security Overview' },
    { href: '#iso-27001', label: '2. ISO 27001 & Certifications' },
    { href: '#encryption', label: '3. Data Encryption' },
    { href: '#access-control', label: '4. Access Control' },
    { href: '#incident-response', label: '5. Incident Response' },
    { href: '#data-residency', label: '6. Data Residency' },
    { href: '#penetration-testing', label: '7. Penetration Testing' },
    { href: '#vulnerability-disclosure', label: '8. Vulnerability Disclosure' },
];
