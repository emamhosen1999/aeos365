...
/**
 * Files & Storage Dashboard - Dynamic Widget Architecture
 * 
 * This dashboard displays only dynamically registered widgets.
 * All storage widgets (stats, storage by type, recent uploads, tenant usage) 
 ...
 */
const FilesDashboard = ({ title = 'Files & Storage Dashboard', dynamicWidgets = [] }) => {
    ...
    return (
        <>
            ...
            <div className="flex flex-col w-full h-full p-4" role="main" aria-label="Files & Storage Dashboard">
                {/* Welcome Section */}
                ...
                {!hasAnyWidgets && (
                    ...
                    >
                        ...
                        >
                            <CloudArrowUpIcon className="w-12 h-12" style={{ color: 'var(--theme-primary)' }} />
                        </div>
                        <h3 className="text-xl font-semibold text-foreground mb-2">
                            No Storage Widgets Available
                        </h3>
                        <p className="text-default-500 max-w-md">
                            Storage widgets will appear here once they are registered by the Platform package.
                            Configure your dashboard widgets to display storage usage, file uploads, and tenant quotas.
                        </p>
                    </motion.div>
                )}
            </div>
...
FilesDashboard.layout = (page) => <App>{page}</App>;
