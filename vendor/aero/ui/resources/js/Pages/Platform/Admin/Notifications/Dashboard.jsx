...
/**
 * Notifications Dashboard - Dynamic Widget Architecture
 * 
 * This dashboard displays only dynamically registered widgets.
 * All notification widgets (stats, recent notifications, channels, broadcasts) 
 ...
 */
const NotificationsDashboard = ({ title = 'Notifications Dashboard', dynamicWidgets = [] }) => {
    ...
    return (
        <>
            ...
            <div className="flex flex-col w-full h-full p-4" role="main" aria-label="Notifications Dashboard">
                {/* Welcome Section */}
                ...
                {!hasAnyWidgets && (
                    ...
                    >
                        ...
                        >
                            <BellAlertIcon className="w-12 h-12" style={{ color: 'var(--theme-primary)' }} />
                        </div>
                        <h3 className="text-xl font-semibold text-foreground mb-2">
                            No Notification Widgets Available
                        </h3>
                        <p className="text-default-500 max-w-md">
                            Notification widgets will appear here once they are registered by the Platform package.
                            Configure your dashboard widgets to display notifications, channels, and broadcast campaigns.
                        </p>
                    </motion.div>
                )}
            </div>
...
NotificationsDashboard.layout = (page) => <App>{page}</App>;
