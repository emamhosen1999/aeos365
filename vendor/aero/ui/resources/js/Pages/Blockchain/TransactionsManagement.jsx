...
const TransactionsManagement = ({ title }) => {
    ...
    const canCreate = auth.permissions?.includes('blockchain.transactions.create') || false;
    const canView = auth.permissions?.includes('blockchain.transactions.view') || false;
