...
/**
 * Integrations Dashboard - Dynamic Widgets Only
 * 
 ...
 */
const IntegrationsDashboard = ({ title = 'Integrations Dashboard', dynamicWidgets = [] }) => {
    ...
    return (
        <>
            <Head title={title} />
            <div className="flex flex-col w-full h-full p-4" role="main" aria-label="Integrations Dashboard">
                    ...
                    {!hasAnyWidgets && (
                        ...
                        >
                            ...
                            <p className="text-default-500 text-center max-w-md">
                                ...
                                Widgets will appear here once they are registered by the integrations module.
                            </p>
                        </motion.div>
                    )}
                </div>
...
IntegrationsDashboard.layout = (page) => <App>{page}</App>;
