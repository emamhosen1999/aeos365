...
<body>
    <div class="header">
        ...
        <p>Payslip for <?php echo e($payslip->pay_period); ?></p>
    </div>

    <div class="content">
        <p>Dear <?php echo e($employee->name); ?>,</p>

        <p>Greetings! Your payslip for <strong><?php echo e($payslip->pay_period); ?></strong> has been generated and is ready for your review.</p>
        ...
        <div class="employee-info">
            ...
            <div class="info-row">
                ...
                <span><?php echo e($employee->employee_id ?? $employee->id); ?></span>
            </div>
            <div class="info-row">
                <span class="info-label">Pay Period:</span>
                <span><?php echo e($payroll->pay_period_start->format('d M Y')); ?> to <?php echo e($payroll->pay_period_end->format('d M Y')); ?></span>
            </div>
            <div class="info-row">
        ...
        <div class="salary-summary">
            ...
            <div class="info-row">
                ...
                <span>₹ <?php echo e(number_format($payroll->total_deductions, 2)); ?></span>
            </div>
            <div class="net-salary">
                Net Salary: ₹ <?php echo e(number_format($payroll->net_salary, 2)); ?>
        ...
        <div style="text-align: center; margin-top: 30px;">
            ...
            <p style="color: #2563eb;"><?php echo e(config('app.name')); ?></p>
        </div>
    </div>
...
</html><?php /**PATH C:\laragon\www\Aero-Enterprise-Suite-Saas\packages\aero-ui\resources\views\emails\payslip.blade.php ENDPATH**/ ?>