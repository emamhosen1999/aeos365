...
<head>
    ...
    <link rel="icon" type="image/png" sizes="192x192" href="<?php echo e(asset('icon-192.png')); ?>">
    <?php endif; ?>
...
<body>
    ...
    <?php if(!empty($customCssUrl)): ?>
    <link rel="stylesheet" href="<?php echo e($customCssUrl); ?>">
    <?php endif; ?>
